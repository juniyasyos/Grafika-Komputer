...
class Battle:
    ...
    def cek_basic_attack(self):
        if self.enemies:
            for enemy in self.enemies:
                enemy.create_basic_attack_enemy(AttackActor, enemy, self.current_time, enemy.last_BasicAttack_time, cooldown_basicAttack=gp.random.randint(2000, 5000), count_all_enemy=len(self.enemies))
